			...
			<div class="bg-level-2-page-width-container l-page-width no-padding">
				<section class="kids_bottom_content_container">
					...
					if(isset($_POST['realanswer'])){
						include('includes/addition/addition1.inc.php'); 
					}else if(isset($_GET['sum']) && (!isset($_GET['low']))){
						include('includes/addition/add_low.inc.php');
					}else if(isset($_GET['high'])){
						include('includes/addition/addition2.inc.php');
					}else if(isset($_POST['begin'])){
						include('includes/addition/add.inc.php');
					}else if(isset($_GET['low'])){
						include('includes/addition/add_high.inc.php');
					}else{
						include('includes/addition/add_instructions.inc.php'); 
					}
					 ?>
