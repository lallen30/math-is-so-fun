...
<head>
	...
	<script src="http://localhost:8080/js/modernizr.custom.js"></script>
</head>

<body class="t-blue t-pattern-1 secondary-page t-menu-1 t-header-1 t-text-1"><?php include_once("includes/analyticstracking.php") ?>
			...
			<div class="bg-level-2-page-width-container l-page-width no-padding">
				<section class="kids_bottom_content_container">
					...
					<div class="entry-container">
						...
						<p class="instructionText">Coming soon:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fractions, Equations, games and much much more...</p>
