						...
						<aside id="sidebar">
							...
							<div class="nav_cat type-1 widget">
								...
								if (isset($_SESSION["userid"])) {
									echo $welcomessage;
									if ($userroleidquery == '3') {
										echo '<p><a href="parents_page.php">Parent\'s Page</a></p>';
									} else if ($userroleidquery == '4') {
										echo '<p><a href="kids_page.php">My Page</a></p>';
									}
								} else if ($insertgood == '4' && $username == $userquery) {
									echo 'Verifying user information. Please wait...<META http-equiv="refresh" content="5;URL=db/login.php?username=' . $username . '"> ';
								} else { ?>

									<h1>Log in:</h1>

									<form action="login.php" method="post" class="loginsidebar">
