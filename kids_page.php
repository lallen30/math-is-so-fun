					...
					<div id="sbr" class="entry-container">
						<div id="post-content">
							...
							<?php if ($userroleidquery == '4') { ?>
								...
								<?php
								$missmultisql = $mysqli->query("SELECT * FROM missed WHERE user_id = '" . $mysqli->real_escape_string($useridquery) . "' AND type = '3'");
								while ($missmultirow = $missmultisql->fetch_assoc()) {
