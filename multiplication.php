...
<body onload="document.myForm.answer.focus();" class="t-blue t-pattern-1 secondary-page t-menu-1 t-header-1 t-text-1"><?php include_once("includes/analyticstracking.php") ?>
