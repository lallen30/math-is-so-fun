			...
			<div class="bg-level-2-page-width-container l-page-width no-padding">
				<section class="kids_bottom_content_container">
					...
					if(isset($_POST['realanswer'])){
						include('includes/subtraction/subtraction1.inc.php'); 
					}else if(isset($_GET['answer']) && (!isset($_GET['low']))){
						include('includes/subtraction/sub_low.inc.php');
					}else if(isset($_GET['high'])){
						include('includes/subtraction/subtraction2.inc.php');
					}else if(isset($_POST['begin'])){
						include('includes/subtraction/sub_low.inc.php');
					}else if(isset($_GET['low'])){
						include('includes/subtraction/sub_high.inc.php');
					}else{
						include('includes/subtraction/sub_instructions.inc.php'); 
					}
					 ?>
